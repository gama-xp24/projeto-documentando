                        ...
                        <div class="header1">
                            <div class="menu1">
                                <ul> 
                                    ...
                                    <li style="color: red" ><a href="">CADASTRE-SE</a></li>
                                </ul>
                            </div>
                        </div>
                    </main>
            ...
            <section class="wrapper text-dark mt-5" id="our-blog">
                <div class="d-flex-c container">
                    <div class="my-2">
                        ...
                        <br>
                        <h4 class="text-center " style="color: red"> O blog da Documentando <b>te ensina</b> a otimizar os processos de organização, o compartilhamento e proteção dos documentos da<b> sua empresa.</b></h4>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form">
                                    <h3  class="pb-3 text-center " style="color: white">Não perca nenhum conteúdo e seja o 1° a aplicar as <b>melhores práticas</b>. <br>Cadastre-se para receber todos os nossos conteúdos <b> EXCLUSIVOS !</b> :</h3>
